...
class Wechat {
    ...
    const MSG_TYPE_KEFU    = 'transfer_customer_service';
    ...
    public function __construct($token){
        if($token){
            ...
            /*true || self::auth($token) || exit;

            $this->data = array(
                'ToUserName' => 'gh_331653e1311d',
                'FromUserName' => 'oyTuRs1B9oLX_Hhug2oUr4yQ4TqM',
                'CreateTime' => '1436103490',
                'MsgType' => 'text',
                'Content' => '2',
                'MsgId' => '6168017523429315719',
            );
    ...
    public function response($content, $type = self::MSG_TYPE_TEXT){
        ...
        } elseif($type == self::MSG_TYPE_KEFU) {
    ...
    public function replyKefu($text){
        return $this->response(null, self::MSG_TYPE_KEFU);
    }
    ...
    private static function transfer_customer_service($content){
        return null;
    }
