...
class User extends ModelBasic
{
    ...
    {
        $field='now_money,uid,nickname,phone,avatar,sign_num,status,level,user_type,pay_count,fans,follow,sex,birthday,signature,total_sign,support_count,introduction,forum_count,post_count,exp,fly,gong,buy,one,two,three,four,five,is_collect,mark,icon,is_red,collect,overdue_time,is_permanent';
