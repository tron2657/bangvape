    ...
    public static function options()
    {
        ...
        if(isset($payment['pay_weixin_open']) && $payment['pay_weixin_open'] == 1){
            $config['payment'] = [
                ...
                'notify_url'=>Request::instance()->domain().Url::build('ebapi/Notify/notify')
            ];
        }
        return $config;
    }
    ...
    public static function handleNotify()
    {
        self::paymentService()->handleNotify(function($notify, $successful){
            if($successful && isset($notify->out_trade_no)){
                ...
                return HookService::listen('wechat_pay_success',$notify,null,true,PaymentBehavior::wechatPaySuccessProduct($notify->out_trade_no,$notify));
            }
        });
    }
