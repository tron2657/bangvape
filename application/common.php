 ...
 *时间：2020.6.15
 */
function app_send_message_one($uid,$content,$from_type,$link_id,$title){
    return true;//暂时注释掉
    return \app\commonapi\controller\AppMessage::app_send_message_one($uid,$content,$from_type,$link_id,$title);
}
 ...
 *时间：
 */
function  app_send_message_all($title,$content){
    return true;//暂时注释掉
    return \app\commonapi\controller\AppMessage::app_send_message_all($title,$content);
}