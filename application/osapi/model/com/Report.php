...
class Report extends BaseModel
{
    ...
    public static function is_deal_message($v,$to_uid,$action=''){
        ...
        if($set['status']==1){
            $message_id=Message::sendMessage($to_uid,$now_uid,$template,1,$set['title'],1,'','index','');
    ...
    public static function delete_forum_message($report){
        ...
        if($set['status']==1){
            $message_id=Message::sendMessage($thread['author_uid'],$now_uid,$template,1,$set['title'],1,'','index','');
