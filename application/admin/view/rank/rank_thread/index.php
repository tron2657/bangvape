            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        {{# } }}
                        {{# if(d.type == 2){ }}
                        <a  class="layui-btn layui-btn-xs" href="{:Url('com.com_thread/index')}?id={{d.tid}}&type=6" >
                            查看详情
                        </a>
                        {{# } }}
                        {{# if(d.type == 3){ }}
                        <a  class="layui-btn layui-btn-xs" href="{:Url('com.com_thread/index')}?id={{d.tid}}&is_weibo=1" >
                            查看详情
                        </a>
                        {{# } }}
                        {{# if(d.type == 4){ }}
                        <a  class="layui-btn layui-btn-xs" href="{:Url('com.com_thread/index')}?id={{d.tid}}&type=4" >
                            查看详情
                        </a>
                        {{# } }}
