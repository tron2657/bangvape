    ...
    <div class="layui-tab layui-tab-brief" lay-filter="tab">
        <ul class="layui-tab-title">
            ...
            <li lay-id="list" {eq name='type' value='4'}class="layui-this" {/eq}>
                <a href="{eq name='type' value='4'}javascript:;{else}{:Url('index',['type'=>4])}{/eq}">已经售罄产品({$outofstock})</a>
            </li>
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='type'}
                            ...
                            <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{h:document.body.clientHeight,w:document.body.clientWidth})">添加产品</button>
                            {else/}
                            <button class="layui-btn layui-btn-sm" data-type="unable">添加产品</button>
                            {/if}
