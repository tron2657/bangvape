...
<div id="store-attr" class="mp-form" v-cloak="">
    <i-Form :label-width="80" style="width: 100%" v-show="hidden == false">
        <Form-Item>
            <Row>
                <i-Col span="5">
                    <i-Button type="dashed" long @click="hiddenBool" icon="plus-round">添加新规格</i-Button>
                </i-Col>
            </Row>
        </Form-Item>
    </i-Form>
            ...
            <template v-for="(attr,index) in attrs">
                <Form-Item>
                    <Row>
                        ...
                        <i-Col span="4" offset="3" style="margin-right: 2px;margin-top: 10px">
                            <span :class="attr.check ? 'check':''">剥比:</span>&nbsp;&nbsp;<i-Input placeholder="剥比" v-model="attr.strip_num" style="width: 60%"
                                                                                                   :number="true"></i-Input>
                        </i-Col>
                        <i-Col span="3" style="margin-right: 2px;margin-top: 10px">
                        ...
                        <i-Col span="2" style="margin-right: 3px;margin-top: 10px">
