                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="layui-table" lay-skin="nob" lay-size="lg">
                                    ...
                                    <tr>
                                        <th></th>
                                        <th class="center-box question-box">用户访问数
                                            <img class="question-img" src="{__ADMIN_PATH}images/question.png" alt="">
                                    ...
                                    <tr>
                                        <td>今日</td>
                                        <td class="center-box today">{$system_count.today.new_count}</td>
                                        <td class="center-box today">{$system_count.today.active_count}</td>
                                        <td class="center-box today">{$system_count.today.view_count}</td>
                                        <td class="center-box today">{$system_count.today.total_count}</td>
                                        <td class="center-box today">{$system_count.today.share_count}</td>
                                    </tr>
                                    <tr>
                                        <td>昨日</td>
                                        <td class="center-box">{$system_count.yesterday.new_count}</td>
                                        <td class="center-box">{$system_count.yesterday.active_count}</td>
                                        <td class="center-box">{$system_count.yesterday.view_count}</td>
                                        <td class="center-box">{$system_count.yesterday.total_count}</td>
                                        <td class="center-box">{$system_count.yesterday.share_count}</td>
                                    </tr>
                                    <tr class="first-box">
                                        <td>每日平均</td>
                                        <td class="center-box">{$system_count.average.new_count}</td>
                                        <td class="center-box">{$system_count.average.active_count}</td>
                                        <td class="center-box">{$system_count.average.view_count}</td>
                                        <td class="center-box">{$system_count.average.total_count}</td>
                                        <td class="center-box">{$system_count.average.share_count}</td>
                                    </tr>
                                    <tr class="first-box">
                                        <td>历史峰值</td>
                                        <td class="center-box">{$system_count.max.new_count}</td>
                                        <td class="center-box">{$system_count.max.active_count}</td>
                                        <td class="center-box">{$system_count.max.view_count}</td>
                                        <td class="center-box">{$system_count.max.total_count}</td>
                                        <td class="center-box">{$system_count.max.share_count}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        <img class="down-img" id="first_down" src="{__ADMIN_PATH}images/down.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title data-box">
                    ...
                    <div class="ibox-content data-content">
                        ...
                        <img class="down-img" id="second_down" src="{__ADMIN_PATH}images/down.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        new Vue({
            ...
            methods:{
                ...
                getCensusMessage:function(){
                    var that=this;
                    axios.get("{:Url('admin/community.index/get_census_message')}").then((res)=>{
                ...
                communityInfo:function () {
                    ...
                    var that=this;
                    axios.post("{:Url('admin/community.index/get_census')}",{limit: index}).then((res)=>{
                ...
                changeStatisType:function (index,type){
                    ...
                    var that = this;
                    axios.post("{:Url('admin/community.index/get_census')}",{limit: limit,field:type}).then((res)=>{
                        console.log(res.data.data.series)
                        console.log(Math.max.apply(null, res.data.data.series))
                ...
                getCommunitys:function(num){
                    var that = this
                    axios.post("{:Url('admin/community.index/census_rank')}",{order: num}).then((res)=>{
...
//                        series: data.series
            ...
            mounted:function () {
                ...
                $("#first_down").on("click",function () {
                    if(firstState){
                        $(this).attr("src","{__ADMIN_PATH}images/down.png")
                    }else {
                        $(this).attr("src","{__ADMIN_PATH}images/up.png")
                    }
