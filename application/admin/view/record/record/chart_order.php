                            ...
                            <div class="layui-row layui-col-space10 layui-form-item">
                                <div class="layui-col-lg12">
                                    ...
                                    <div class="layui-input-block" v-cloak="">
                                        <button class="layui-btn layui-btn-sm" :class="{'layui-btn-primary':status!==item.value}" @click="setwhere(item,1)" type="button" v-for="item in statusList" style="margin-top: 0px;">{{item.name}}</button>
                                    </div>
                                </div>
                                <div class="layui-col-lg12">
                                    <label class="layui-form-label">产品类型:</label>
                                    <div class="layui-input-block" v-cloak="">
                                        <button class="layui-btn layui-btn-sm" :class="{'layui-btn-primary':type!=item.value}" @click="setwhere(item,2)" type="button" v-for="item in typeList" style="margin-top: 0px;">{{item.name}}</button>
                                    </div>
                                </div>
                                <div class="layui-col-lg12">
                                    <label class="layui-form-label">创建时间:</label>
                                    <div class="layui-input-block" data-type="data" v-cloak="">
                                        <button class="layui-btn layui-btn-sm" type="button" v-for="item in dataList" @click="setwhere(item,3)" :class="{'layui-btn-primary':data!=item.value}" style="margin-top: 0px;">{{item.name}}</button>
                                        <button class="layui-btn layui-btn-sm" type="button" ref="time" @click="setwhere({value:'zd',is_zd:true},3)" :class="{'layui-btn-primary':data!='zd'}" style="margin-top: 0px;">自定义</button>
                                ...
                                <div class="layui-col-lg12">
                                    <div class="layui-input-block">
                                        ...
                                        <button class="layui-btn layui-btn-warm layui-btn-sm export" type="button" style="margin-top: 0px;">
