                            ...
                            <div class="layui-row layui-col-space10 layui-form-item">
                                <div class="layui-col-lg12">
                                    ...
                                    <div class="layui-input-block" data-type="data" v-cloak="">
                                        <button class="layui-btn layui-btn-sm" type="button" v-for="item in is_status" @click="setStatus(item)" :class="{'layui-btn-primary':status!==item.value}" style="margin-top: 0px">{{item.name}}</button>
                                    </div>
                                </div>
                                <div class="layui-col-lg12">
                                    <label class="layui-form-label">身　　份:</label>
                                    <div class="layui-input-block" data-type="data" v-cloak="">
                                        <button class="layui-btn layui-btn-sm" type="button" v-for="item in is_promoter" @click="setPromoter(item)" :class="{'layui-btn-primary':Promoter!==item.value}" style="margin-top: 0px">{{item.name}}</button>
                                    </div>
                                </div>
                                <div class="layui-col-lg12">
