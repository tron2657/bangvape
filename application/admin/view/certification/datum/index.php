...
<!--                                        </a>-->
                                <button class="btn btn-warning btn-xs" lay-event='delstor' type="button"><i class="fa fa-warning"></i> 删除</button>
                                {{# }else{ }}
                                {{# } }}
                            </script>
                        </div>
...
<script>
    ...
    layList.tableList('List',"{:Url('list')}",function (){
        ...
        join=[
            ...
            {field: 'name', title: '名称'},
            {field: 'input_tips', title: '提示语'},
            {field: 'form_type', title: '样式'},
            {field: 'setting', title: '参数'},
            {field: 'use_range', title: '关联功能'},
