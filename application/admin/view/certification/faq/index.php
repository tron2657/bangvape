    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                ...
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{$addurl}')">添加问题</button>
                {else/}
                <button type="button" class="btn btn-w-m btn-primary" data-type="unable">添加问题</button>
                {/if}
                ...
                <div class="row">
                    <div class="m-b m-l">
                        ...
                        <div class="input-group">
                            <input type="text" name="keyword" value="{$params.keyword}" placeholder="请输入关键词/问题标题" class="input-sm form-control"> <span class="input-group-btn">
