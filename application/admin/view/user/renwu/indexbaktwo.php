    ...
    layui.use(['form','layer','laydate','table','laytpl'],function(){
        ...
        var tableIns = table.render({
            ...
            cols : [[
                ...
                {field: 'leixing', title: '任务类型' },
                {field: 'jifenflag', title: '积分标志'},
                {field: 'name', title: '任务名称'  },
                {field: 'explain', title: '任务描述'  },
                {field: 'icon', title: '图标'  , templet:'#icon' },
                {field: 'require', title: '完成要求'  },
                {field: 'exp', title: '经验值',edit:'exp'  },
                {field: 'fly', title: '社区积分',edit:'fly' },
                {field: 'gong', title: '贡献',edit:'gong'  },
                {field: 'buy', title: '购物积分',edit:'buy' },
                {field: 'one', title: '自定义积分1',edit:'one' },
                {field: 'status', title: '状态',templet:'#is_show' },
                {field: 'right', title: '操作',toolbar:'#act' }
            ]]
        });
        ...
        form.on('switch(zt)', function (data) {
            ...
            setTimeout(function () {
                ...
                id = data.elem.value;
                //alert(status);
                $.post("/admin/xiajia.html", {id: id, zt: status}, function (data) {
                    var icon = 5;
                    if (data.code) {
                        icon = 6;
                    }
