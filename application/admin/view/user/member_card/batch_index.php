...
<div class="layui-fluid" style="background: #fff">
    <div class="layui-tab layui-tab-brief" lay-filter="tab">
        <ul class="layui-tab-title">
            ...
            <a href="{eq name='activity_type' value='2'}javascript:;{else}{:Url('card_index',['activity_type'=>2])}{/eq}">激活码列表</a>
            </li>
        </ul>
    </div>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs" lay-event='export'> <i class="fa fa-floppy-o" style="margin-right: 3px;"></i>导出Excel </button>
                        <button type="button" class="layui-btn layui-btn-xs" lay-event='export_txt'> <i class="fa fa-floppy-o" style="margin-right: 3px;"></i>导出Txt </button>
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List', "{:Url('batch_list',[])}",function (){
        return [
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            ...
            case 'export':
                ...
                break;
            case 'export_txt':
                location.href=layList.U({c:'user.member_card',a:'card_list',q:{card_batch_id:data.id,cardsn:1}});
                break;
        }
    })
