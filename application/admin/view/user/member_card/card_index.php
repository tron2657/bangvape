...
<div class="layui-fluid" style="background: #fff">
    <div class="layui-tab layui-tab-brief" lay-filter="tab">
        <ul class="layui-tab-title">
            ...
            <a href="{eq name='activity_type' value='2'}javascript:;{else}{:Url('card_index',['activity_type'=>2])}{/eq}">激活码</a>
            </li>
        </ul>
    </div>
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="card_sn" class="layui-input" placeholder="请输入序列号">
...
<script>
    ...
    layList.tableList({
        ...
        return [
            ...
            {field: 'card_sn', title: '激活码', sort: true,width:'20%',align: 'center'},
