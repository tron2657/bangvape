...
<div class="layui-fluid">
    <div class="layui-row la
    yui-col-space15"  id="app">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="alert alert-info" role="alert">
                        想天小助手提醒：商城、知识商城在添加商品时支持单个商品“赠送积分”分值设置，该功能为一对一针对设置，此处【积分规则编辑】-购买商品、购买知识商城为统一设置，建议两者选其一设置即可。如以上两处都设置了赠送积分，则用户购买成功后将同时获得两处对应积分。以上请务必注意。
        ...
        var tableIns = table.render({
            ...
            cols : [
                ...
                [
                    ...
                    {field: 'num', title: '每日奖励上限次数',rowspan:2,edit:'num'},
