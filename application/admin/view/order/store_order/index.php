                            ...
                            <div class="layui-card-body">
                                <div class="layui-row layui-col-space10 layui-form-item">
                                    ...
                                    <div class="layui-col-lg12">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="user_address" style="width: 50%" v-model="where.user_address" placeholder="请输入上门地址（支持模糊查询）" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-col-lg12">
                                        <div class="layui-input-block">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="recieve_tp">
                        核销时间：{{d.recieve_time=='0' ? '未核销':'<br>'+d.recieve_time}}<br/>
                        上门地址：<br/> <span style="color:blue">{{d.user_address==null ? '暂无信息':d.user_address}}</span><br/>
                        核销人：{{d.check_user_name==null ? '暂无信息':d.check_user_name}}
                    </script>
                    <!--用户信息-->
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','{:Url('delivery')}?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退积分','{:Url('integral_back')}?id={{d.id}}',{w:document.body.clientWidth,h:document.body.clientHeight})">
                                    <i class="fa fa-history"></i> 退积分
                                </a>
                            </li>
                            {{#  };}}
                            ...
                            {{# } ;}}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('拒绝退款','{:Url('refund_n')}?id={{d.id}}',{w:document.body.clientWidht,h:document.body.clientHeight})">
                                    <i class="fa fa-openid"></i> 拒绝退款
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('订单记录','{:Url('order_status')}?oid={{d.id}}')">
...
<script>
    layList.tableList('List',"{:Url('order_list',['real_name'=>$real_name])}",function (){
        return [
            ...
            {field: 'status', title: '领取状态',templet:'#status',width:'8%'},
            {field: 'add_time', title: '优惠券兑换时间',width:'10%',sort: true},
            // {field: 'remark', title: '备注',width:'8%'},
            {field: 'recieve_tp', title: '领取信息',width:'10%',templet:'#recieve_tp'},
        ...
        new Vue({
            ...
            data: {
                ...
                orderType: [
                    ...
                    // {name: '试用订单', value: 10,count:orderCount.trail},
                    // {name: '会员权益订单', value: 11,count:orderCount.membership},
                    // {name: '礼品卡订单', value: 12,count:orderCount.membership},
                    // {name: '礼品卡兑换订单', value: 13,count:orderCount.membership},
                    // {name: '试用订单', value: 3,count:orderCount.seckill},
//                    {name: '砍价订单', value: 4,count:orderCount.bargain},
                ],
                orderStatus: [
                    {name: '全部', value: ''},
                    {name: '待领取', value: 1,count:orderCount.wf},
                    {name: '已领取', value: 3,count:orderCount.dp},
                    {name: '已过期', value: -1,count:orderCount.tk,class:true},
