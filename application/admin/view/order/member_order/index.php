        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div style="font-weight: bold;">会员订单 </div>
                </div>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="status">
                       ...
                       <span style="display: inline-block;height: 24px;line-height: 24px;padding: 0 10px;background-color: #009688;color: #fff;white-space: nowrap;text-align: center;font-size: 14px;border: none;border-radius: 2px;cursor: pointer;"
                             onclick="$eb.createModalFrame('退款原因','{:Url('reason_refund')}?oid={{d.id}}',{w:800,h:600})">退款原因</span>
                       {{# }; }}
                    </script>
                    <!--商品信息-->
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('订单记录','{:Url('order.store_order/order_status')}?oid={{d.id}}')">
                                    <i class="fa fa-newspaper-o"></i> 订单记录
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('订单详情','{:Url('order.store_order/order_info')}?oid={{d.id}}')">
                        ...
                        {{#  }else if(d._status==2){ }}
                        {{# if(d.type==2){ }}
                        <button class="btn btn-primary btn-xs" type="button" onclick="$eb.createModalFrame('发送货','{:Url('deliver_goods')}?id={{d.id}}',{w:400,h:250})">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            {{#  if(d.pay_price != d.refund_price){ }}
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('退款','{:Url('refund_y')}?id={{d.id}}',{w:400,h:250})">
                                    <i class="fa fa-history"></i> 立即退款
                                </a>
                            </li>
                            {{#  if(d.type!=1){ }}
...
{block name="script"}
<script>
    layList.tableList('List',"{:Url('order_list',['real_name'=>$real_name,'types'=>11])}",function (){
        return [
            ...
            {field: 'info', title: '商品信息',templet:"#info",width:'21%'},
    ...
    require(['vue'],function(Vue) {
        new Vue({
            ...
            data: {
                ...
                orderType:[
                    {name: '会员订单', value: 11,count:orderCount.vip,class:true},
                ],
                where:{
                    data:'',
                    status:'',
