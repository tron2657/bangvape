                ...
                <div class="<!--ibox-content--> p-m m-t-sm">
                        <div class="box">
                            ...
                            <div class="top line" style="position: relative;left: -27px;">
                                <div style="position: relative;left: 33px;"><span>是否开启活动</span></div>
                                ...
                                <div style="position: relative;left: 27px">如关闭活动，则前端不会在【我的】页面、常用工具中显示"活动"图标及入口</div>
                            </div>
                            <div class="bottom line">
                                <div style="position: relative;left: 6px;"><span>活动支持积分类型</span></div>
...
function submit() {
    $.post("{:Url('save_score_type')}",{is_on:is_on,flag:flag},function (res) {
