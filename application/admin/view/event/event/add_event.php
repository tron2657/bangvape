...
<form class="layui-form" action="" id="signupForm">
          ...
          bindEvent:function(){
              map.addEventListener('click', function (e) {     
                  ...
                  gc.getLocation(point,function(rs){
                      ...
                      $("#detailed_lat").val(e.latlng.lat);
                      $("#detailed_lng").val(e.latlng.lng);
  ...
  <div class="layui-form-item-me layui-required" {if condition="$event['type'] eq 0"}style="display:none;"{/if}  id="form-item-detailed_lat">
    <label class="layui-form-label-me layui-required">具体地址坐标lat</label>
    <div class="layui-input-block-me">
      <input name="detailed_lat" id="detailed_lat"  lay-verify="required" type="text" placeholder="请输入活动具体地址" class="layui-input-me layui-input-inline" value="{$event['detailed_lat']}">
      <div class="layui-form-mid-me  layui-word-aux">如果活动地址与具体地址不一致请手动输入</div>
    </div>
  </div>
  <div class="layui-form-item-me layui-required" {if condition="$event['type'] eq 0"}style="display:none;"{/if}  id="form-item-detailed_lng">
    <label class="layui-form-label-me layui-required">具体地址坐标lng</label>
    <div class="layui-input-block-me">
      <input name="detailed_lng" id="detailed_lng"  lay-verify="required" type="text" placeholder="请输入活动具体地址" class="layui-input-me layui-input-inline" value="{$event['detailed_lng']}">
      <div class="layui-form-mid-me  layui-word-aux">如果活动地址与具体地址不一致请手动输入</div>
    </div>
  </div>
  <div class="layui-form-item-me layui-required">
...
layui.use('form', function(){
    ...
    form.on('radio(type)', function (data) {        
           ...
           if (data.value == "0") {
             ...
             $("#form-item-detailed_lat").hide();
             $("#form-item-detailed_lng").hide();
           }
           else {
            $("#form-item-address").show();
             $("#form-item-detailed_address").show();
             $("#form-item-detailed_lat").show();
             $("#form-item-detailed_lng").show();
           }
           form.render();
       });
...
$('#save_event').click(function () {
  ...
  data.detailed_lat=$('#detailed_lat').val();
  data.detailed_lng=$('#detailed_lng').val();
  ...
  if(data.type == 1){
    ...
    if(data.detailed_lat == ''){ $eb.message('error','请输入活动具体地点坐标');return false;}
    if(data.detailed_lng == ''){ $eb.message('error','请输入活动具体地点坐标');return false;}
