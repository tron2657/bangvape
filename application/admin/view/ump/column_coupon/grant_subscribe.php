                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-primary btn-xs grant" data-url="{:Url('ump.columnCouponUser/grant_subscribe',array('id'=>$vo['id']))}" type="button"><i class="fa  fa-arrow-circle-o-right"></i> 发放
                                </button>
                            </td>
                        </tr>
                        {/volist}
