                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-primary btn-xs" type="button"  onclick="$eb.createModalFrame('修改状态','{:Url('edit',array('id'=>$vo['id']))}',{w:document.body.clientWidth,h:document.body.clientHeight})"><i class="fa fa-paste"></i> 修改状态</button>
                                {/neq}
