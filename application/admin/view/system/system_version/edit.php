                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="{:Url('edit')}">
                            ...
                            <input type="hidden" value="1" name="is_post"/>
                            {volist name="list" id="vo"}
                            {eq name="$vo['config_tab_id']" value="$tab_id"}
                            <div class="form-group" id="form_{$vo['menu_name']}">
...
//                                                dump($parameter);
                                            ...
                                            <div class="radio i-checks checked" style="display:inline" >
                                                <label class="" style="padding-left: 0;"  data-role="radio_{$vo['menu_name']}" data-value="{$son[0]}">
