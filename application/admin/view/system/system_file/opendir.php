            ...
            <div class="ibox-content  no-padding">
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            <td class="text-left">
                                <span onclick="$eb.createModalFrame('{$vo.filename}','{:Url('openfile')}?file={$dir}/{$vo.filename}',{w:document.body.clientWidth,h:document.body.clientHeight})"> <i class="fa fa-file-text-o"></i> {$vo.filename}</span>
                            </td>
                            <td class="text-left">
                                <span> {$vo.size}</span>
                            </td>
                            ...
                            <td class="text-center">
                                <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('{$vo.filename}','{:Url('openfile')}?file={$dir}/{$vo.filename}',{w:document.body.clientWidth,h:document.body.clientHeight})"><i class="fa fa-paste"></i> 编辑</button>
