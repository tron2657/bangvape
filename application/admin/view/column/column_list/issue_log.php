    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="table-responsive" id="list_list">
...
//        });
        ...
        list(1);
        function list(page) {
            var listid=$('#id_value').val();
            $.post("{:Url('column.column_list/get_issue_log')}",{id:listid,page:page},function (re) {
                console.log(re);
                if(re.code == 200){
                    $('#list_list').empty().append(re.data.html);
                }else{
                    $eb.message('error',re.msg);
                }
            });
