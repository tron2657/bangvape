    ...
    <form class="form-horizontal layui-form">
        ...
        <div>
            ...
            <div class="cloud-video-upload">
                <div class="upload-tips">请上传以*.mp3格式为主的视频文件，上传过程中请耐心等待提示</div>
                <div class="layui-upload-list" id="video-expand"></div>
                <div class="button-box"  style="position: relative">
                    <button type="button" class="layui-btn layui-btn-normal" id="qcloud-video-select" style="cursor: pointer">
                        选择音频文件
                    </button>
                    ...
                    <button type="button" class="layui-btn" id="qcloud-video-upload" style="background-color: #009688">
                        开始上传
                    </button>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-control" style="height:auto">
                        <label style="color:#ccc">音频上传：请上传 *.cda , *.wav , *.mp3 格式的音频文件</label>
...
<script>
    ...
    $('#video-file').on('change', function() {
        ...
        var tag = $(['<span class="uploaded-info" id="upload1">',
            ...
            '<span><button class="layui-btn layui-btn-xs layui-btn-danger in-delete" style="background-color: #FF5722">删除</button></span>',
            '</span>'].join(''));
...
<script>
    ...
    $("#save").on("click",function () {
        ...
        if (video_info !== "") {
            list.info = video_info.video.url;/* 音频 */
        } else {
            list.info = audio_url;
        }
        if(list.category_id === ""){
