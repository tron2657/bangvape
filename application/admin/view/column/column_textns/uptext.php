                      ...
                      <input type="hidden" name="id" value="{$data.id}">
                       ...
                       <div class="form-group">
                           <div class="col-md-12">
                               ...
                               <textarea type="text/plain" id="myEditorn" style="width:100%;">{$data.info}</textarea>
                           </div>
                       </div>
                       <div class="form-group">
                           <div class="col-md-12">
                               <div class="col-md-6">
                                   <label style="color:#aaa">期刊状态</label>
                                   <br/>
                                   <input type="radio" name="is_show" class="layui-radio" value="0" {if $data.is_show == 0} checked {/if}>否
                                   <input type="radio" name="is_show" class="layui-radio" value="1" {if $data.is_show == 1} checked {/if}>是
                               </div>
                               <div class="col-md-6">
                                   <label style="color:#aaa">是否为试读</label>
                                   <br/>
                                   <input type="radio" name="is_read" class="layui-radio" value="0" {if $data.is_read == 0} checked {/if}>否
                                   <input type="radio" name="is_read" class="layui-radio" value="1" {if $data.is_read == 1} checked {/if}>是
                               </div>
                           </div>
                       </div>
