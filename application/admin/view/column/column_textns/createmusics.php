                   ...
                   <form class="form-horizontal" id="signupForm">
	                   ...
	                   <div class="cloud-video-upload">
		                   ...
		                   <div class="button-box"  style="position: relative">
                               ...
                               <input type="file" style="position: absolute;opacity: 0;left: 217px;top: 7px;width: 120px;" id="video-file" class="video-file">
...
var audio_url;
  ...
  console.log("{:Url('widget.uplodes/upload')}")
...
//                $('.upload').trigger('click');
            ...
            * */
            $('.save_news').on('click',function(){
                ...
                list.type = 2;/* 类型 */
                if (video_info) {
                    list.info = video_info.video.url;/* 内容 */
                } else {
                    list.info = audio_url;
                }/* 内容 */
