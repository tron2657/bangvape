            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        ...
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{h:700,w:1100})">添加作者</button>
                        {else/}
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('author_list')}",function (){
        return join=[
            {field: 'id', title: 'ID', sort: true,event:'id',width:'6%'},
            {field: 'nickname', title: '作者',width:'6%'},
            {field: 'summary', title: '简介'},
            {field: 'avatar', title: '头像',templet:'#image',width:'10%'},
