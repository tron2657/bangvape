            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('扩展设置','{:Url('admin/com.comThreadClassExtend/edit')}?class_id={{d.id}}')">
                           扩展设置
                        </button>
                    </script>
                    ...
                    <script type="text/html" id="extend">
                     {{# if(d.extend!=null) { }}
                        是否开启:{{d.extend.tg_enable}}<br>
                        开始时间:{{d.extend.tg_start_time}}<br>
                        结束时间:{{d.extend.tg_end_time}}<br>
    ...
    layList.tableList('List',"{:Url('class_list',['fid'=>$fid, 'status'=>$status])}",function (){
        if(status == '-1'){
            ...
            return [
                ...
                {field: 'extend', title: '扩展属性',templet:'#extend'},
