                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content" style="display: block;padding-bottom: 0px;">
                            <form class="layui-form">
                                ...
                                <div class="layui-col-lg12 top-distance">
                                ...
                                <div class="layui-col-lg12" style="display:flex;margin-top: 8px;">
                                ...
                                <div class="layui-form-item" style="padding-top:10px">
                                    <label class="layui-form-label">
                                        <button class="layui-btn layui-btn-sm layui-btn-normal" lay-submit="" lay-filter="search" style="margin-top: 1px;">
...
<!--                                 </div>-->
                                ...
                                <script type="text/html" id="operation_uid">
                                 ...
                                 <script type="text/html" id="barDemo">
                                     {{#  if(d.is_deal!=='已处理'){ }}
                                     <button type="button" class="layui-btn layui-btn-xs show-btn" onclick="$eb.createModalFrame('举报处理','{:Url('do_report')}?id={{d.id}}',{w: 710, h: 750})">举报处理</button>
