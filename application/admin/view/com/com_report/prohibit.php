    ...
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">禁言类型</div>
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        <button type="button" class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('prohibit_create')}')" style="margin-top: 10px">添加禁言类型</button>
                    </div>
                    ...
                    <script type="text/html" id="act">
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('编辑禁言时间','{:Url('prohibit_create')}?id={{d.id}}')">
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('prohibit_list')}",function (){
        return [
            {field: 'id', title: 'ID', sort: true,event:'id',width:'6%'},
            {field: 'type', title: '类型'},
            {field: 'num', title: '禁言时长'},
            {field: 'time_type', title: '单位'},
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            case 'delstor':
                var url=layList.U({c:'com.com_report',a:'delete_time',q:{id:data.id}});
