            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='status'}
                            {case value="0"}
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create_message')}',{h:document.body.clientHeight,w:document.body.clientWidth})">创建通知</button>
                            {/case}
                            {case value="1"}
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create_message')}',{h:document.body.clientHeight,w:document.body.clientWidth})">创建通知</button>
                            {/case}
                    ...
                    <script type="text/html" id="act_one">
                        ...
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('编辑','{:Url('edit')}?id={{d.id}}',{h:document.body.clientHeight,w:document.body.clientWidth})">
                            <i class="fa fa-paste"></i> 编辑
                        </button>
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('详情','{:Url('view')}?id={{d.id}}',{h:document.body.clientHeight,w:document.body.clientWidth})">
...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('message_list',['status'=>$status])}",function (){
        var join=new Array();
