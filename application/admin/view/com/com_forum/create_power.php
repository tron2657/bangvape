            ...
            <div class="ivu-form-item">
                ...
                <div class="ivu-form-item-content">
                    <div  class="ivu-radio-group">
                        ...
                        <label class="ivu-radio-wrapper ivu-radio-group-item {if condition='$data.audit eq 1'}ivu-radio-wrapper-checked{/if}" data-show="show" data-id="audit">
                                <span class="ivu-radio {if condition='$data.audit eq 1'}ivu-radio-checked{/if}">
                                    <span class="ivu-radio-inner"></span>
                                    <input type="radio" class="ivu-radio-input" name="audit" value="1" {if condition='$data.audit eq 1'}checked{/if}>
                                </span>
                               开启审核
                        </label>
                        <div  id="choose_group_box_audit" style="margin-top: 5px;width: 220px; {if condition='$data.audit neq 1'}display: none{/if} ">
                            <input type="text" id="audit_id" name="audit_id" class="layui-input ivu-input"  placeholder="请输入申请原因填写框提示文字"  value="{$data['audit_id']}">
                        </div>
                    </div>
