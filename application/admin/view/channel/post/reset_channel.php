                    ...
                    <div class="right">
                        <div class="row">
                            <form id="reset_form" class="form-horizontal" action="" style="padding:20px;">
                                ...
                                <input type="hidden" name="now_channel" value="{$now_channel}">
                                <input type="hidden" name="is_type" value="{$is_type}">
                                <div class="form-group">
                                    <label for="post_type" class="control-label"><span style="color: red;margin-right: 5px;">*</span>频道推送形式:</label>
                                    <div class="input_label" style="min-height: 70px;">
                            ...
                            <div style="text-align: center">
                                <button type="button" id="save_reset_btn" class="btn btn-primary" style="padding: 10px 50px;margin: 20px 15px 44px;background-color: #0ca6f2;width: 80% ">提交</button>
                            </div>
                        </div>
                    <div>
                </div>
