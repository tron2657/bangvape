...
<div class="row zzl_page_list" style="width: 100%;margin-left: 0;">
    <div class="col-sm-12 zzl_page_list_content" style="background-color: #fff">
        ...
        <form id="form" class="form-horizontal zzl_page_list_child layui-form" style="margin-top: 50px;overflow-y: visible">
            <style>
                .right_input {
                    width: 150px;
            ...
            <div class="form-group layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" id="post_type1" name="post_type[]" value="1" title="自动推送" lay-filter="post_type">
                    <input type="checkbox" id="post_type2" name="post_type[]" value="2"  title="手动推送" lay-filter="post_type">
                </div>
            </div>
            ...
            <div id="user_push_set_block" style="display: none">
                ...
                <div class="recommend_block">
                    <div class="form-group">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" id="post_audit1" name="post_audit" value="1" title="开启">
                            <input type="radio" id="post_audit0" name="post_audit" value="0" title="关闭">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div id="auto_push_set_block" style="display: none">
                ...
                <div class="recommend_block" style="padding: 0 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 block" style="padding-top: 40px;">
                            <div class="form-group input_label">
                                <label class="col-sm-2 checkbox-inline checkbox_label" style="    margin-right: 0;
    text-align: right;
    line-height: 35px;
    padding: 0 16px 10px;">
                                    <input type="radio" id="from_type0" name="from_type" value="0" style="margin-top: 12px" title="来自版块">
                                </label>
                                <div class="col-sm-8">
    ...
    line-height: 35px;
    padding: 0 16px 10px;">
                                    <input type="radio" id="from_type1" name="from_type" value="1" style="margin-top: 12px" title="来自用户">
                                </label>
                                <div class="col-sm-8">
    ...
    line-height: 35px;
    padding: 0 16px 10px;">
                                    <input type="radio" id="from_type2" name="from_type" value="2" style="margin-top: 12px" title="来自全站">
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8" style="padding-top: 40px;">
                            <div class="form-group">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" id="condition_post_hot_type1" name="condition_post_hot_type" value="1" title="同时满足三项">
                                    <input type="radio" id="condition_post_hot_type2" name="condition_post_hot_type" value="2" title="满足其中一项">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"></label>
                                <div class="col-sm-8">
                                    <div>1.评论数大于等于<input type="text" name="condition_post_hot_comment" class="form-control right_input" maxlength="6" placeholder="请输入数字" value="{$channel['condition_post_hot_comment']}"></div>
                                    <div>2.阅读数大于等于<input type="text" name="condition_post_hot_read" class="form-control right_input" maxlength="6" placeholder="请输入数字" value="{$channel['condition_post_hot_read']}"></div>
                                    <div>3.点赞数大于等于<input type="text" name="condition_post_hot_support" class="form-control right_input" maxlength="6" placeholder="请输入数字" value="{$channel['condition_post_hot_support']}"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="condition_post_type" class="col-sm-2 control-label">帖子类型</label>
                                <div class="layui-input-block">
                                    <input type="radio" id="condition_post_type0" name="condition_post_type" value="0" title="全部">
                                    <input type="radio" id="condition_post_type1" name="condition_post_type" value="1" title="只取精华帖">
                                    <input type="radio" id="condition_post_type2" name="condition_post_type" value="2" title="只取置顶帖">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="layui-input-block">
                                    <input type="checkbox" id="condition_post_content1" name="condition_post_content[]" value="1" title="帖子">
                                    <input type="checkbox" id="condition_post_content2" name="condition_post_content[]" value="2" title="视频">
                                    <input type="checkbox" id="condition_post_content3" name="condition_post_content[]" value="3" title="资讯">
                                    <input type="checkbox" id="condition_post_content4" name="condition_post_content[]" value="4" title="动态">
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8" style="padding-top: 40px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" data-role="select_block">
                                    <select name="list_page_limit" id="list_page_limit" class="form-control" lay-filter="reset_select">
                                        <option value="">--请选择--</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" data-role="select_block" style="display: flex">
                                    <select name="list_update_interval" id="list_update_interval"  class="form-control" lay-filter="reset_select">
                                        <option value="">--请选择--</option>
                                        <option value="5">5</option>
                                        <option value="10">10</option>
                                        <option value="自定义">自定义</option>
                                    </select>
                                    <select name="list_update_interval_type" id="list_update_interval_type"  class="form-control" lay-filter="reset_select" style="width: 30%" value="{$channel['list_update_interval_type']}">
                                        <option value="0" {if condition="$channel['list_update_interval_type'] eq 0"}selected{/if}>分</option>
                                        <option value="1" {if condition="$channel['list_update_interval_type'] eq 1"}selected{/if}>时</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
...
<script>
    ...
    $('[data-role="select_block"]').focusin(function () {
        $('#form').css("padding-bottom","200px");
    })
    $('[data-role="select_block"]').focusout(function () {
    ...
    $(function () {
        ...
        layui.use(['form'],function(){
            var form = layui.form;
            form.on('checkbox(post_type)', function(data){
            ...
            form.on('select(reset_select)', function(data){
                check_show_hide();
            });
        });
        ...
        $('#save_btn').on('click',function(){
            ...
            var title = $("#title").val();
            var code = {title:"确认将「"+title+"」同步到用户吗？",text:"仅该频道同步到全部用户的频道列表，不影响用户对其他频道的自定义设置",type:'info',confirm:'确定',cancel:"取消"};
            $.ajax({
                ...
                success:function(re){
                    if(re.code == 200){
                        ...
                        if(re.data.id){
                            $eb.$swal('delete2',function(state){
                                console.log(state)
                                if(state == true){
                                    $.ajax({
