    ...
    <div class="layui-row layui-col-space15 zzl_page_list"  id="app">
        <div class="zzl_page_list_content">
            ...
            <div class="layui-col-md12" style="margin-top: 15px;">
                <div class="layui-card">
                    <div class="layui-card-header">系统频道</div>
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="act">
                            {{# if(d.id == 1){ }}
								...
								<a class="layui-btn layui-btn-xs" href="{:Url('user.user_recommend/index')}?channel_id={{d.id}}" >
...
<script>
    ...
    //加载列表
    layList.tableList('List',"{:Url('channel_list',['type'=>1])}",function (){
        return [
