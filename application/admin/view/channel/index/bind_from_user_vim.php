...
<script>
    ...
    var add_storage_user=function () {
        var usernames=JSON.parse(window.localStorage.getItem("bind_from_usernames"));
        if(usernames==undefined){
            $.ajax({
                url:"{:Url('get_already_from_user')}",
            ...
            var userids=JSON.parse(window.localStorage.getItem("bind_from_userIds"));
            var selectHtml='';
            for(var i=0;i<100;i++){
    ...
    $('#save').on('click',function(){
        ...
        window.localStorage.setItem("bind_from_usernames",JSON.stringify(selectName));
        window.localStorage.setItem("bind_from_userIds",JSON.stringify(selectVal));
