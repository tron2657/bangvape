...
<div class="layui-fluid">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="sensitive" v-model="where.sensitive" class="layui-input" placeholder="请输入敏感词关键字">
                                        </div>
                                    </div>
                                </div>
                                <div class="layui-col-lg12">
    ...
    <div class="layui-row layui-col-space15" >
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">触发记录</div>
                <div class="layui-card-body">
...
<script>
    layList.tableList('List',"{:Url('log_list')}",function (){
        return [
            {field: 'id', title: 'ID'},
            {field: 'action', title: '触发事件'},
            {field: 'content', title: '触发内容',templet:'#content',width:'16%'},
            {field: 'sensitive', title: '涉及敏感词'},
            {field: 'nickname', title: '触发人'},
