                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-body">
                                <div class="form-group clearfix">
                                    <label class="col-sm-2 tips" for="">关键字</label>
                                    <div class="col-sm-10 group-item">
                                        <input style="resize: none;width: 100%;padding:  6px 12px;" v-model="keyword" type="text" name="keyword" placeholder="请输入关键字" {if condition="$key"}disabled="disabled"{/if} />
                                    </div>
                                </div>
                                <div class="form-group clearfix">
            ...
            methods: {
                ...
                check: function(){
                    ...
                    if(this.keyword.trim() == '')
                        return this.returnError('请输入关键字');
                    if(this.keyword.trim() == 'subscribe')
                        return this.returnError('请重新输入关键字');
                    if(this.keyword.trim() == 'default')
                        return this.returnError('请重新输入关键字');
                    switch (this.type){
                        case 'text':
                ...
                selectNews:function(){
                    ...
                    i = $eb.createModalFrame('选择图文消息',"{:Url('admin/wechat.wechatNewsCategory/select',['callback'=>'_selectNews$eb'])}",{w:document.body.clientWidth});
                }
            },
            mounted: function () {
                window.vm = this;
