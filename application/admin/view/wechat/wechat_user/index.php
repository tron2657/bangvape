                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="save_mark" href="javascript:void(0);"  onclick="$eb.createModalFrame('修改分组','{:Url('edit_user_group',['openid'=>$vo['openid']])}',{w:document.body.clientWidth,h:document.body.clientHeight})" >
                                                        修改分组
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="save_mark" href="javascript:void(0);" onclick="$eb.createModalFrame('修改标签','{:Url('edit_user_tag',['openid'=>$vo['openid']])}',{w:document.body.clientWidth,h:document.body.clientHeight})" >
                                                        修改标签
                                                    </a>
                                                </li>
                                                <li>
...
//        var url = "http://"+window.location.host+"/admin/ump.store_coupon/grant/id/"+str;
        ...
        $eb.createModalFrame(this.innerText,url,{'w':document.body.clientWidth});
    })
