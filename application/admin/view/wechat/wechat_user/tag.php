    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create_tag')}',{w:document.body.clientWidth,h:document.body.clientHeight})">添加标签</button>
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('edit_tag',['id'=>$vo['id']])}',{w:document.body.clientWidth,h:document.body.clientHeight})"><i class="fa fa-paste"></i> 编辑</button>
