...
<!--                            <a onclick="$eb.createModalFrame(this.innerText,'{:Url('edit',array('id'=>$vo['id']))}')" href="javascript:void(0)">编辑</a>-->
                            <a onclick="$eb.createModalFrame(this.innerText,'{:Url('modify',array('id'=>$vo['id']))}',{w:document.body.clientWidth,h:document.body.clientHeight})" href="javascript:void(0)">编辑</a>
...
<script>
    ...
    $('.append-filed').on('click',function (e) {
        $eb.createModalFrame(this.innerText,"{:Url('append')}",{w:document.body.clientWidth,h:document.body.clientHeight});
    });
