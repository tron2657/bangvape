...
<div class="layui-fluid">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">推广订单列表</div>
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="user_info">
                        ...
                        <div style="display: flex;align-items: center">
                            <img style="cursor: pointer;margin-right: 5px;" onclick="javascript:$eb.openImage(this.src);"
...
<script>
  ...
  layList.tableList('List', "{:Url('sell_order_list',['seller_uid'=>$seller_uid])}", function () {
    switch ('1') {
      case '1':
        var join = [
          {field: 'order_id', title: '订单号', width: '13%'},
          {field: 'user_info', templet: '#user_info', title: '用户信息', width: '14%'},
          {field: 'product_info', templet: '#product_info', title: '商品信息', width: '15%'},
          {field: 'pay_money', title: '实付金额', align: 'center', width: '10%'},
          {field: 'order_status_show', align: 'center', title: '订单状态', width: '12%'},
          {field: 'create_time_show', title: '下单时间', align: 'center', width: '12%'},
          {field: 'back_status_show', title: '分销状态', align: 'center', width: '12%'},
          {field: 'back_money', title: '返佣金额', align: 'center'},
        ];
        break;
    }
    return join;
  ...
  require(['vue'],function(Vue) {
    new Vue({
      ...
      data: {
        ...
        type:[
          {name:"全部",value:"all"},
          {name:"一级推广人订单",value:"level1"},
          {name:"二级推广人订单",value:"level2"},
        ],
        where:{
          select_date:'',
          type:'',
