                         ...
                         <?php $count = count($list); ?>
                            {if condition="$count"}
                                {volist name="list" id="vo"}
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('推荐人列表','{:Url('stair',['uid'=>$vo['uid']])}',{'w':document.body.clientWidth})">
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-white  btn-xs"  onclick="$eb.createModalFrame('佣金记录','{:Url('now_money',['uid'=>$vo['uid']])}',{'w':document.body.clientWidth})">
