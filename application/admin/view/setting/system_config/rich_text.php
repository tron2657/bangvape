  ...
  <div class="col-sm-12" style="background-color: #fff">
    ...
    <div class="form" style="margin: 20px">
      <div class="input-box" style="display: flex;align-items: flex-start;">
        ...
        <textarea type="text/plain" id="myEditor" style="width:700px;margin-left: 10px;">{$content}</textarea>
      </div>
...
<script>
  ...
  $('#save_btn').on('click',function(){
    ...
    list.meun_name='<?=$menu_name?>';
    list.agreement_id='<?=$agreement_id?>';
    $.ajax({
      url:"{:Url('save_rich_text')}",
      data:list,
      type:'post',
      dataType:'json',
      success:function(re){
