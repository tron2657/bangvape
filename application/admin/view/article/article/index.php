    ...
    <div class="col-sm-9 m-l-n-md">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create',array('cid'=>$where.cid))}',{w:document.body.clientWidth,h:document.body.clientHeight})">添加文章</button>
                ...
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('create',array('id'=>$vo['id'],'cid'=>$where.cid))}',{w:document.body.clientWidth,h:document.body.clientHeight})"><i class="fa fa-paste"></i> 编辑</button>
