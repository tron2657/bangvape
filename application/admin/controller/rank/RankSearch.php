...
class RankSearch extends AuthController
{
    ...
    public function edit($id)
    {
        ...
        $field = [
            ...
            Form::radio('is_default','是否默认搜索',$rank->getData('is_default'))->options([['label'=>'是','value'=>1],['label'=>'否','value'=>0]]),
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $data['end_time']=strtotime($data['end_time']);
        $data['type']=2;
        if ($data['is_default'] == '1') RankSearchModel::where('is_default', 1)->update(['is_default' => 0]);
