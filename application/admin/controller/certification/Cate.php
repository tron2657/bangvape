...
class Cate extends AuthController
{
    ...
    public function update(Request $request)
    {
       ...
       //更新用户组名称zxh 2020.8.27
        db('group')->where(['type'=>5,'bind_condition'=>$id])->update(['name'=>$data['name'],'remark'=>$data['desc']]);
    ...
    public function delete()
    {
        ...
        if(!$res){
            ...
            db('group')->where(['type'=>5,'bind_condition'=>$id])->update(['status'=>-1]);
