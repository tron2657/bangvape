...
//            })->filterable(1)->multiple(1),
            ...
            Form::checkbox('use_range','关联功能',[])->options([['value'=>0,'label'=>'用户资料项编辑'],['value'=>1,'label'=>'认证'],['value'=>2,'label'=>'活动'],['value'=>4,'label'=>'产品试用']]),
    ...
    public function save(Request $request)
    {
        ...
        $data['use_range']=implode(',', $data['use_range']);
        DatumModel::set($data);
    ...
    public function edit()
    {
        ...
        $FiledTypeList=getCertificationDatumFiledTypeList();
        $data['use_range']=explode(',',$data['use_range']);
        $field = [
...
//            })->filterable(1)->multiple(1),
            ...
            Form::checkbox('use_range','关联功能', $data['use_range'])->options([['value'=>0,'label'=>'用户资料项编辑'],['value'=>1,'label'=>'认证'],['value'=>2,'label'=>'活动'],['value'=>4,'label'=>'产品试用']]),
