...
use app\admin\model\column\StoreProduct;
    ...
    public function create(Request $request)
    {
        ...
        if($data['is_show']==1){
            ...
            if($set['status']==1){
                ...
                //最新消息内容更新
                unset($data1['to_uid']);
                Message::update_message_census($uids,'message',$data1);
                //最新消息内容更新end

                //发送app消息
//                foreach ($message as $v){
//                    app_send_message_one($v['to_uid'],$v['content'],'column_details',$v['link_id'],$v['title']);
//                }
//                unset($v);
	...
	public function ifYunUpload(){
		...
		$string['son'] = $getTencentConfig['tencent_video_vodsub_appid'];
