...
class Request
{
     ...
     * @return mixed
     */
    public function param($name = '', $default = null, $filter = 'text')
    {
     ...
     * @return mixed
     */
    public function get($name = '', $default = null, $filter = 'text')
    {
        if (empty($this->get)) {
            $this->get = $_GET;
        }
     ...
     * @return mixed
     */
    public function post($name = '', $default = null, $filter = 'text')
    {
        if (empty($this->post)) {
            $content = $this->input;
