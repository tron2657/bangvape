...
use app\admin\model\shop\shopOrder as AdminShopOrder;
...
//        AdminStoreOrder::sendOrderGoods($oid,$data);
    ...
    public static function shopProductOrderDeliveryGoodsAfter($data,$oid){
        AdminShopOrder::orderPostageAfter($oid,$data);
//        AdminStoreOrder::sendOrderGoods($oid,$data);
    }
