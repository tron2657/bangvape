 ...
 */
class RoutineTwoTemplateService implements ProviderInterface
{
     ...
     * @return bool|mixed
     */
    public static function sendTemplate($openId = '',$tempCode = '',$dataKey = array(),$link = '',$formId = '',$defaultColor=null)
    {
