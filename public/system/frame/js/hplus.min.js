...
function requestFullScreen(e) {
    ...
    if(elem.webkitRequestFullScreen){
        ...
        e.html('<i class="zyk zyk-fullscreen-exit"><span class="tooltiptext tooltipbottom">退出<i class="Sharp_corners"></i></span></i>');
        e.addClass('unscreen');
...
function exitFullscreen(e) {
    ...
    e.html('<i class="zyk zyk-fullscreen"><span class="tooltiptext tooltipbottom">全屏<i class="Sharp_corners"></i></span></i>');
...
layer.config({
    ...
    $(document).ready(function() {
        ...
        $("#side-menu").metisMenu(),
            ...
            $(".navbar-minimalize").click(function() {
                $("body").toggleClass("mini-navbar"),$(".plus-content").toggle(),
                    SmoothlyMenu()
            }),
            e(),
    ...
    $(window).bind("load resize",
        function() {
            $(this).width() < 769 && ($("body").addClass("mini-navbar"), $(".navbar-static-side").fadeIn(), $(".plus-content").hide())
        }),
    $(function() {
