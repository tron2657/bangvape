$(function() {
    ...
    function c() {
        var o = $(this).attr("href"),
            m = $(this).data("main"),
            l = $.trim($(this).text()) == '' ? $.trim($(this).attr('title')) : $.trim($(this).text()),
            k = true;
	...
	$(document).on('click', '.searchListBox a',function(){
            // console.log($(this).html(),'J_menuItem的打印');
			$(this).addClass('J_menuItem');
	});
